...
const ImageAnalyzer: React.FC = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            const response = await analyzeImageWithGemini(image, prompt, geminiApiKey);
                            ...
                            {!currentSession && (
                                <div className="mt-6 space-y-4">
                                    ...
                                    <button
                                        ...
                                        className={`w-full py-3 rounded-lg flex items-center justify-center gap-2 font-bold text-white transition-all ${!image || isAnalyzing
